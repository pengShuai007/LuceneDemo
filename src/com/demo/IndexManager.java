...
public class IndexManager {
	...
	private static String INDEX_DIR = "F:\\Workspaces\\eclipse_mine\\LuceneDemo\\luceneIndex";
	private static String DATA_DIR = "F:\\Workspaces\\eclipse_mine\\LuceneDemo\\luceneData";
	...
	public static void searchIndex(String text) {
		...
		try {
			...
			for (int i = 0; i < hits.length; i++) {
				...
				System.out.println("文件内容："+hitDoc.get("content"));
